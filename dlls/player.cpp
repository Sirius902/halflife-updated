...
void CBasePlayer::UpdateClientData()
{
	...
	// Send velocity to the client
	MESSAGE_BEGIN(MSG_ONE, gmsgVelocity, nullptr, edict());
	WRITE_FLOAT(pev->velocity.x);
	WRITE_FLOAT(pev->velocity.y);
	WRITE_FLOAT(pev->velocity.z);
	MESSAGE_END();
